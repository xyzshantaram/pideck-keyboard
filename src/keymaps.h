...
const int num_keymap[NROWS * NCOLS] = {
  KEY_LEFTBRACE, KEY_RIGHTBRACE, KEY_1, KEY_2, KEY_3, KEY_MINUS, KEY_UNDEFINED, KEY_BACKSPACE,
  KEY_UNDEFINED, KEY_UNDEFINED, KEY_4, KEY_5, KEY_6, KEY_EQUAL, KEY_SEMICOLON, KEY_UNDEFINED,
  KEY_UNDEFINED, KEY_UNDEFINED, KEY_UNDEFINED, KEY_7, KEY_8, KEY_9, KEY_SLASH, KEY_UNDEFINED,
